...
using TileType = TileTemplate.TileType;
...
public partial class MeshMaker: MonoBehaviour
{
    ...
    public static void CreateWall(GameObject wall, MaterialDatabase materialDatabase, WallInstructions instructions, bool wrap, Grid<TileTemplate> tiles, float roundedness)
    {
    ...
    public static void OnCreateHouseWall(List<WallData> instructions, ref Vector2Int currentGridPosition, bool wrap, Grid<TileTemplate> tiles, int wallIndex, ref int indexJump, float roundedness, ref List<Vector3> allVertices, ref List<int> allIndices, ref List<Vector2> allUVs)
    {
        //Go through each wall
        WallData currentWall = instructions[wallIndex];
